...
* @Last modified time: 2017-02-24T16:47:11+07:00
 */
...
class NexxHAPIServer {
  ...
  constructor(commonLib, options) {
    ...
    if (options.config.user.autoProfile) {
  ...
  _init(options) {
    ...
    server.ext('onRequest', (request, reply) => {
      ...
      request.common = {
        pagingParams: request.query ? new helpers.models.PagingQuery(helpers.Uri.parseQuery(request.query)) : null,
        params: request.query ? helpers.Uri.parseQuery(request.query) : null
      };
