...
class NodeRoute {
  ...
  createCreateRoute(options) {
    ...
    options.config.notes = `Responses successfully created data`;
  ...
  createUpdateRoute(options) {
    ...
    options.config.notes = `Responses successfully updated data`;
  ...
  createDeleteRoute(options) {
    ...
    options.config = options.config || {};
    options.config.handler = options.config.handler || this._controller.delete;
